...
namespace PublishTemplate
{
    ...
    class DuplicateViewUtils
    {
        ...
        public static Dictionary<ElementId, ElementId> DuplicateSchedules(Document fromDocument, IEnumerable<ViewSchedule> views, Document toDocument)
        {
            Dictionary<ElementId, ElementId> scheduleGraphicIDMap = new Dictionary<ElementId, ElementId>();
            ...
            scheduleGraphicIDMap = DuplicateElementsAcrossDocuments(fromDocument, ids, toDocument, true);
            return scheduleGraphicIDMap;
        }
        ...
        public static Dictionary<ElementId, ElementId> DuplicateDraftingViews(Document fromDocument,
                                                    ...
                                                    Document toDocument)
        {
                ...
                "API - Duplication across documents with detailing"))
            {
                ...
                viewMap = DuplicateElementsAcrossDocuments(fromDocument, ids, toDocument, true);
